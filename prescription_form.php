...
<head>
    ...
    <style>
        ...
        /* Optional: make sidebar scrollable if content is tall */
        .sidebar {
            height: 100vh;
            overflow-y: auto;
...
<div class="flex min-h-screen">
    <!-- Sidebar -->
    <div class="sidebar w-1/4 bg-white shadow-md">
        <?php include 'sidebar.php' ?>
    </div>

    <!-- Main Content -->
    <div class="flex-1 p-7 bg-white shadow-md rounded-lg mx-4 my-4">
...
<script>
    ...
    medicineForm.addEventListener('submit', function (e) {
        ...
        if (editIndex !== null) {
            ...
            editIndex = null;
            submitLabel.textContent = 'បន្ថែមថ្នាំ';
        } else {
    ...
    function editPrescription(index) {
        ...
        editIndex = index;
        submitLabel.textContent = 'កែប្រែថ្នាំ';
    }
